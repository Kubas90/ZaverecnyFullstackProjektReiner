...
public class PersonServiceImpl implements PersonService {
    ...
    @Override
    public List<InvoiceDTO> getAllSellersByIdentificationNumber(String identificationNumber) {
    ...
    @Override
    public List<InvoiceDTO> getAllBuyersByIdentificationNumber(String identificationNumber) {
        return invoiceRepository.findAll()
                .stream()
